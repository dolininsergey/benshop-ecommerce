...
$(function(){$("#my-menu").mmenu({navbars:[{position:"bottom",content:["<a class='fa fa-facebook' href='#/'></a>","<a class='fa fa-twitter' href='#/'></a>","<a class='fa fa-pinterest' href='#/'></a>","<a class='fa fa-youtube' href='#/'></a>"]},{position:"bottom",content:["<span class='copyright'>© 2017 Flinto. All rights reserved</span>"]}],extensions:["effect-menu-slide","pagedim-black"],navbar:!1,offCanvas:{position:"right"}}),$("#my-menu").data("mmenu").bind("open:finish",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".category").hover(function(){$(this).css({border:"solid 3px #000"})},function(){$(this).css({border:"none"})}),$(".featured-products-carousel").owlCarousel({loop:!0,margin:20,items:4,responsiveClass:!0,responsive:{0:{items:1,margin:0},768:{items:3},960:{items:4}}}),$(".featured-product").hover(function(){$(this).find(".product-button").css("display","flex"),$(this).find(".product-image").css("border","solid 1px #000")},function(){$(this).find(".product-button").css("display","none"),$(this).find(".product-image").css("border","none")}),$(".close-button").click(function(){$(".alarm-banner").css("display","none")})});